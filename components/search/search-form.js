      ...
      <div className="block relative w-4/5 group">
        ...
        <input
          ...
          onChange={( event ) => setSearchQuery( event.target.value )}
           className=" hidden form-control text-gray relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal bg-white dark:bg-black dark:tet-white dark:border bg-clip-padding rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
