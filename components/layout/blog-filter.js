  ...
  return (
    <div className="flex px-2 py-2 grid  ">
        ...
        <form className="flex content-center inline-block m-auto relative float-left"  onSubmit={handleBlogFilterFormSubmit}>
                <select  id="authors" name="selectedAuthor" value={selectedAuthor} onChange={(e) => {setAutValue(e.target.value);}} className="border border-lightblue text-gray2 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block  px-4 py-2 pr-8 rounded "> 
                ...
                <select  id="categories" name="selectedCategory" value={selectedCategory} onChange={(e) => {setCatValue(e.target.value);}} className="border border-lightblue text-gray2 text-xs rounded-lg block  px-4 py-2 pr-8 rounded "> 
