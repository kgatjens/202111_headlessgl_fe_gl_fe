...
export default function Home({ data, homepage, carouselHomepage }) {
  ...
  const featuredImage =
    allHomepage.edges[0]?.node.homepageFields.headerImage.mediaItemUrl;
        ...
        <Container>
          {allHomepage && (
            <Homepage
              ...
              descriptionText={
                allHomepage.edges[0]?.node.homepageFields.initialDescriptionText
              }
              headerImageURL={
                allHomepage.edges[0]?.node.homepageFields.headerImage
                  .mediaItemUrl
              }
              headerImageAltText={
                allHomepage.edges[0]?.node.homepageFields.headerImage.altText
              }
              sectionBackgrounURL={
                allHomepage.edges[0]?.node.homepageFields.sectionBackgroundImage
                  .mediaItemUrl
              }
              ...
              sectionColor={
                allHomepage.edges[0]?.node.homepageFields.sectionColor
              }
